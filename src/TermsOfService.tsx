...
export default function TermsOfService() {
  ...
  const canonicalUrl = `https://quickconvertunits.com${getLangPrefix(currentLang)}/terms`;

  return (
    <div className="min-h-screen text-neutral-900 dark:text-neutral-100 font-sans p-6 md:p-12">
      <Helmet>
        <title>Terms of Service | QuickConvert</title>
        <meta name="description" content="Read the Terms of Service for QuickConvert to understand the rules and guidelines for using our unit conversion tools." />
        ...
        {supportedLangs.map(l => (
          <link 
            ...
            rel="alternate" 
            hrefLang={l} 
            href={`https://quickconvertunits.com${getLangPrefix(l)}/terms`} 
          />
        ))}
        <link rel="alternate" hrefLang="x-default" href="https://quickconvertunits.com/terms" />
      </Helmet>
