  ...
  return (
    ...
    >
      ...
      <div className="border-t border-neutral-200 dark:border-neutral-800 pt-8 pb-4 flex flex-col items-center justify-center text-center text-xs text-neutral-500 gap-4">
        ...
        <div className="mb-4">
          <a href="https://www.producthunt.com/products/quickconvert-units?embed=true&amp;utm_source=badge-featured&amp;utm_medium=badge&amp;utm_campaign=badge-quickconvert-units" target="_blank" rel="noopener noreferrer">
            <img alt="QuickConvert Units - Free and Instant unit conversions | Product Hunt" width="250" height="54" src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1147714&amp;theme=neutral&amp;t=1778959919180" className="w-[250px] h-[54px]" />
          </a>
        </div>
