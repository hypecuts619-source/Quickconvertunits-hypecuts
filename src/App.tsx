            ...
            >
              ...
              <div className="border-t border-neutral-200 dark:border-neutral-800 pt-8 pb-4 flex flex-col items-center justify-center text-center text-xs text-neutral-500 gap-4">
                ...
                <div className="flex gap-4 mt-1 mb-2">
                  <a href="https://www.youtube.com/@Quickconvertunits" itemProp="sameAs" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF0000] transition-colors" aria-label="YouTube channel">
